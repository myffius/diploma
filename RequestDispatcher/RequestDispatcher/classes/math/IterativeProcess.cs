...
namespace RequestDispatcher.RdMath.Iterations
{
    ...
    public abstract class IterativeProcess
    {
        ...
        public double DesiredPrecision
        {
            ...
            {
                if (value <= 0)
                    throw new ArgumentOutOfRangeException("Non-positive precision: " + value);
        ...
        public int MaximumIterations
        {
            ...
            {
                if (value < 1)
                    throw new ArgumentOutOfRangeException("Non-positive maximum iteration: " + value);
        ...
        {
            return x > DhbMath.DefaultNumericalPrecision ? epsilon / x : epsilon;
        }
