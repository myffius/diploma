...
namespace RequestDispatcher.RDMath
{
    ...
    public sealed class NormalDistribution : ProbabilityDensityFunction
    {
        ...
        /// Стандартное отклонение (_sigma^2 - дисперсия)
        private double _sigma;

        /// Константа необходимая для расчета нормы
        private static double _baseNorm = RDMath.Sqrt(2 * RDMath.PI);

        /// Серия для вычисления функции ошибки
        ...
        /// @return double функция плотности вероятностей
        ...
        /// Оценка распределения и градиент распределения по параметрам
        /// @param x double
